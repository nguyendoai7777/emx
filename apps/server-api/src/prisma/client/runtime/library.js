...
var as = ue((Ng, ss) => {
  ...
  ss.exports = { supportsColor: Mc, stdout: yi(bi(!0, os.isatty(1))), stderr: yi(bi(!0, os.isatty(2))) };
});
var cs = ue((Lg, us) => {
  'use strict';
  var $c = as(),
...
var zt = globalThis.window?.document !== void 0,
  ...
  Sg = Xr === 'Windows' || globalThis.navigator?.platform === 'Win32' || globalThis.process?.platform === 'win32',
  Rg =
    Xr === 'Linux' ||
...
var Pr = 9e15,
  ...
  Gi = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -Pr, maxE: Pr, crypto: !1 },
  $s,
  Ne,
  w = !0,
  En = '[DecimalError] ',
...
m.toDecimalPlaces = m.toDP = function (e, r) {
  ...
  return (
    (t = new n(t)),
    e === void 0 ? t : (ne(e, 0, Ye), r === void 0 ? (r = n.rounding) : ne(r, 0, 8), y(t, e + t.e + 1, r))
  );
};
...
var L = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (
      (k[p] > (H[p] || 0) && c--,
      o == null ? ((se = o = Vt.precision), (s = Vt.rounding)) : a ? (se = o + (n.e - i.e) + 1) : (se = o),
      se < 0)
    )
      (S.push(1), (h = !0));
    else {
          ...
          ((d = 0),
            ...
            u < 0
              ? ((me = b[0]),
                ...
                I < D && g.unshift(0),
                t(b, g, D, l),
                u == -1 && ((D = b.length), (u = r(k, b, K, D)), u < 1 && (d++, t(b, K < D ? fr : k, D, l))),
                (D = b.length))
              : u === 0 && (d++, (b = [0])),
            (S[p++] = d),
...
function Ji(e, r, t, n) {
  var i,
    ...
    h = t !== void 0;
  if (
    (h ? (ne(t, 1, Ye), n === void 0 ? (n = f.rounding) : ne(n, 0, 8)) : ((t = f.precision), (n = f.rounding)),
    !e.isFinite())
  )
    c = Ws(e);
  else {
    ...
    if (!p[0]) c = h ? '0p+0' : '0';
      ...
      if (
        (s < 0
          ? o--
          : ((e = new f(e)), (e.d = p), (e.e = o), (e = L(e, d, t, n, 0, i)), (p = e.d), (o = e.e), (u = $s)),
        (s = p[t]),
        (a = i / 2),
        (u = u || p[t + 1] !== void 0),
        (u =
...
var hd = { red: ce, gray: Hr, dim: Ce, bold: W, underline: Y, highlightSource: (e) => e.highlight() },
  yd = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function Td(e) {
  ...
  for (let n of e) {
    ...
    let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = r.get(i);
    o
      ? r.set(i, { ...n, argument: { ...n.argument, typeNames: Sd(o.argument.typeNames, n.argument.typeNames) } })
      : r.set(i, n);
  }
...
var Dr = class e extends ze {
  ...
  getDeepField(r) {
    ...
    for (let s of n) {
      let a;
      if (
        (o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof Ir && (a = o.value.getField(Number(s))),
        !a)
      )
        return;
      o = a;
...
function ma(e, r) {
  if (r.kind === 'object')
    for (let t of r.fields) e.hasField(t.name) || e.addSuggestion(new le(t.name, t.typeNames.join(' | ')));
}
function Or(e) {
  let r = [...e],
    t = r.pop();
...
function Nn({ args: e, errors: r, errorFormat: t, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: u } = _n(a, t),
    c = Tn({ message: l, callsite: n, originalMethod: i, showColors: t === 'pretty', callArguments: u });
...
function eo(e, r) {
  e === void 0 &&
    r.isPreviewFeatureOn('strictUndefinedChecks') &&
    r.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: r.getSelectionPath(), underlyingError: Ta });
}
var Xi = class e {
  constructor(r) {
    this.params = r;
...
function $r({ error: e, user_facing_error: r }, t, n) {
  return r.error_code
    ? new z(um(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx })
...
function qr(e = {}) {
  let r = Pm(e);
  return Object.entries(r).reduce((n, [i, o]) => (Fa[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
    select: {},
  });
}
function Pm(e = {}) {
...
var Ba = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  Ua = (e, r, t) => Ba(r).reduceRight((n, i, o, s) => Object.assign({}, ao(e, s.slice(0, o)), { [i]: n }), t);
function Cm(e, r) {
...
function uo(e, r) {
  let t = e._extensions.getAllModelExtensions(r) ?? {},
    n = [_m(e, r), Lm(e, r), xt(t), re('name', () => r), re('$name', () => r), re('$parent', () => e._appliedParent)];
  return he({}, n);
}
function _m(e, r) {
  let t = Te(r),
...
function Gn({ visitor: e, result: r, args: t, runtimeDataModel: n, modelName: i }) {
  ...
  let o = e(r, i, t) ?? r;
  return (
    t.include && Ka({ includeOrSelect: t.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    t.select && Ka({ includeOrSelect: t.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    o
  );
}
...
function sl({ postinstall: e, ciName: r, clientVersion: t, generator: n }) {
  if (
    ...
    e === !0 && !(n?.output && typeof (n.output.fromEnvVar ?? n.output.value) == 'string') && r && r in ol)
  ) {
...
${a.backtrace}`,
  ...
  async requestBatch(r, { transaction: t, traceparent: n }) {
    ...
    ((this.lastQuery = JSON.stringify(i)),
      (this.executingQueryPromise = this.engine?.query(this.lastQuery, JSON.stringify({ traceparent: n }), Ol(t))));
  ...
  class r {
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          ...
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath && ri.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = n.adapter;
