import { withHttpTransferCache } from './chunk-O7LISFRQ.js';
import { CommonModule, DomAdapter, PLATFORM_BROWSER_ID, getDOM, setRootDomAdapter } from './chunk-7LA4MYMM.js';
import { XhrFactory, parseCookieValue } from './chunk-UC72YTJX.js';
import {
  APP_ID,
  ApplicationModule,
  ApplicationRef,
...
import { __spreadValues } from './chunk-PJVWDKLX.js';
...
var REMOVE_STYLES_ON_COMPONENT_DESTROY = new InjectionToken(
  typeof ngDevMode !== void 0 && ngDevMode ? 'RemoveStylesOnCompDestroy' : '',
  {
  ...
  listen(target, event, callback, options) {
    ...
    if (typeof target === 'string') {
      ...
      if (!target) {
        throw new RuntimeError(
          5102,
          (typeof ngDevMode === 'undefined' || ngDevMode) && `Unsupported event target ${target} for event ${event}`
        );
      }
    }
...
//# sourceMappingURL=chunk-6BERZCM5.js.map
