...
function roundNumber(parsedNumber, minFrac, maxFrac) {
  if (minFrac > maxFrac) {
    throw new RuntimeError(
      2307,
      ngDevMode && `The minimum number of digits after fraction (${minFrac}) is higher than the maximum (${maxFrac}).`
    );
  }
  let digits = parsedNumber.digits;
...
var DATE_PIPE_DEFAULT_TIMEZONE = new InjectionToken(
  typeof ngDevMode !== void 0 && ngDevMode ? 'DATE_PIPE_DEFAULT_TIMEZONE' : ''
);
var DATE_PIPE_DEFAULT_OPTIONS = new InjectionToken(
  typeof ngDevMode !== void 0 && ngDevMode ? 'DATE_PIPE_DEFAULT_OPTIONS' : ''
);
...
var PRECONNECT_CHECK_BLOCKLIST = new InjectionToken(
  typeof ngDevMode !== void 0 && ngDevMode ? 'PRECONNECT_CHECK_BLOCKLIST' : ''
);
...
//# sourceMappingURL=chunk-7LA4MYMM.js.map
