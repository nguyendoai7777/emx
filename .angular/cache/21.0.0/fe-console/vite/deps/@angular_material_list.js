import './chunk-YBTR4NJQ.js';
import { NG_VALUE_ACCESSOR } from './chunk-DBXJDY73.js';
import {
  CdkObserveContent,
...
import { NgTemplateOutlet } from './chunk-7LA4MYMM.js';
...
import { Subject, Subscription, merge, takeUntil } from './chunk-PJVWDKLX.js';
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatDivider_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mat-divider-vertical', ctx.vertical)('mat-divider-horizontal', !ctx.vertical)(
          'mat-divider-inset',
          ctx.inset
        );
      }
...
var MatPseudoCheckbox = class _MatPseudoCheckbox {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatPseudoCheckbox_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵclassProp('mat-pseudo-checkbox-indeterminate', ctx.state === 'indeterminate')(
          'mat-pseudo-checkbox-checked',
          ctx.state === 'checked'
        )('mat-pseudo-checkbox-disabled', ctx.disabled)('mat-pseudo-checkbox-minimal', ctx.appearance === 'minimal')(
...
var MatListItemAvatar = class _MatListItemAvatar extends _MatListItemGraphicBase {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatListItemAvatar_Factory(__ngFactoryType__) {
      return (
        ɵMatListItemAvatar_BaseFactory || (ɵMatListItemAvatar_BaseFactory = ɵɵgetInheritedFactory(_MatListItemAvatar))
      )(__ngFactoryType__ || _MatListItemAvatar);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var MatListItemIcon = class _MatListItemIcon extends _MatListItemGraphicBase {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatListItemIcon_Factory(__ngFactoryType__) {
      return (ɵMatListItemIcon_BaseFactory || (ɵMatListItemIcon_BaseFactory = ɵɵgetInheritedFactory(_MatListItemIcon)))(
        __ngFactoryType__ || _MatListItemIcon
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
  ...
  _monitorProjectedLinesAndTitle() {
    this._ngZone.runOutsideAngular(() => {
      this._subscriptions.add(
        merge(this._lines.changes, this._titles.changes).subscribe(() => this._updateItemLines(false))
      );
    });
  }
...
var MatActionList = class _MatActionList extends MatListBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatActionList_Factory(__ngFactoryType__) {
      return (ɵMatActionList_BaseFactory || (ɵMatActionList_BaseFactory = ɵɵgetInheritedFactory(_MatActionList)))(
        __ngFactoryType__ || _MatActionList
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
...
var MatList = class _MatList extends MatListBase {
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatList_Factory(__ngFactoryType__) {
      return (ɵMatList_BaseFactory || (ɵMatList_BaseFactory = ɵɵgetInheritedFactory(_MatList)))(
        __ngFactoryType__ || _MatList
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
...
var MatListItem = class _MatListItem extends MatListItemBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatListItem_Factory(__ngFactoryType__) {
      return (ɵMatListItem_BaseFactory || (ɵMatListItem_BaseFactory = ɵɵgetInheritedFactory(_MatListItem)))(
        __ngFactoryType__ || _MatListItem
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatListItem_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        ɵɵclassProp('mdc-list-item--activated', ctx.activated)(
          ...
          ctx._meta.length !== 0
        )('mat-mdc-list-item-both-leading-and-trailing', ctx._hasBothLeadingAndTrailing())(
...
var MatListOption = class _MatListOption extends MatListItemBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatListOption_Factory(__ngFactoryType__) {
      return (ɵMatListOption_BaseFactory || (ɵMatListOption_BaseFactory = ɵɵgetInheritedFactory(_MatListOption)))(
        __ngFactoryType__ || _MatListOption
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function MatListOption_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵclassProp(
          ...
          ctx.selected && !ctx._selectionList.multiple && ctx._selectionList.hideSingleSelectionIndicator
        )('mdc-list-item--with-leading-avatar', ctx._hasProjected('avatars', 'before'))(
          'mdc-list-item--with-leading-icon',
          ctx._hasProjected('icons', 'before')
        )('mdc-list-item--with-trailing-icon', ctx._hasProjected('icons', 'after'))(
          ...
          'mat-accent',
          ctx.color !== 'primary' && ctx.color !== 'warn'
        )('mat-warn', ctx.color === 'warn')('_mat-animation-noopable', ctx._noopAnimations);
      }
    },
    inputs: {
    ...
    consts: [
      ...
      [1, 'mat-focus-indicator'],
      [1, 'mdc-checkbox'],
      ['type', 'checkbox', 1, 'mdc-checkbox__native-control', 3, 'checked', 'disabled'],
      [1, 'mdc-checkbox__background'],
      ['viewBox', '0 0 24 24', 'aria-hidden', 'true', 1, 'mdc-checkbox__checkmark'],
    ...
    template: function MatListOption_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = ɵɵgetCurrentView();
        ɵɵprojectionDef(_c6);
        ɵɵtemplate(0, MatListOption_ng_template_0_Template, 1, 0, 'ng-template', null, 0, ɵɵtemplateRefExtractor)(
          2,
          ...
          1,
          ɵɵtemplateRefExtractor
        )(4, MatListOption_ng_template_4_Template, 5, 4, 'ng-template', null, 2, ɵɵtemplateRefExtractor);
        ɵɵconditionalCreate(6, MatListOption_Conditional_6_Template, 2, 1, 'span', 4)(
          7,
          MatListOption_Conditional_7_Template,
          2,
          1,
          'span',
          5
        ...
        ɵɵprojection(14, 2);
        ɵɵelementEnd()();
        ɵɵconditionalCreate(15, MatListOption_Conditional_15_Template, 2, 1, 'span', 9)(
          16,
          MatListOption_Conditional_16_Template,
          2,
          1,
          'span',
          9
...
var MatNavList = class _MatNavList extends MatListBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function MatNavList_Factory(__ngFactoryType__) {
      return (ɵMatNavList_BaseFactory || (ɵMatNavList_BaseFactory = ɵɵgetInheritedFactory(_MatNavList)))(
        __ngFactoryType__ || _MatNavList
      );
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
