...
import { Location } from './chunk-7LA4MYMM.js';
...
var CdkScrollable = class _CdkScrollable {
  ...
  ngOnInit() {
    this._cleanupScroll = this.ngZone.runOutsideAngular(() =>
      this._renderer.listen(this._scrollElement, 'scroll', (event) => this._elementScrolled.next(event))
    );
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  measureScrollOffset(from) {
    ...
    return Math.max(
      0,
      measureScrollOffset(from ?? (this.orientation === 'horizontal' ? 'start' : 'top')) - this.measureViewportOffset()
    );
  }
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  _applyChanges(changes) {
    this._viewRepeater.applyChanges(
      ...
      (record, _adjustedPreviousIndex, currentIndex) => this._getEmbeddedViewArgs(record, currentIndex),
      (record) => record.item
    );
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function OverlayOutsideClickDispatcher_Factory(__ngFactoryType__) {
      return (
        ...
        (ɵOverlayOutsideClickDispatcher_BaseFactory = ɵɵgetInheritedFactory(_OverlayOutsideClickDispatcher))
...
var GlobalPositionStrategy = class {
  ...
  apply() {
    ...
    const shouldBeFlushHorizontally =
      (width === '100%' || width === '100vw') && (!maxWidth || maxWidth === '100%' || maxWidth === '100vw');
...
function createOverlayRef(injector, config) {
  ...
  const defaultUsePopover =
    injector.get(OVERLAY_DEFAULT_CONFIG, null, {
      optional: true,
    })?.usePopover ?? true;
...
var CdkMenuTriggerBase = class _CdkMenuTriggerBase {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function CdkMenuTriggerBase_HostBindings(rf, ctx) {
      if (rf & 2) {
        ɵɵattribute('aria-controls', ctx.childMenu == null ? null : ctx.childMenu.id)(
...
var CdkMenuTrigger = class _CdkMenuTrigger extends CdkMenuTriggerBase {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    hostBindings: function CdkMenuTrigger_HostBindings(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵattribute('aria-haspopup', ctx.menuTemplateRef ? 'menu' : null)(
          'aria-expanded',
          ctx.menuTemplateRef == null ? null : ctx.isOpen()
        );
      }
    },
    inputs: {
...
var CdkMenuBase = class _CdkMenuBase extends CdkMenuGroup {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function CdkMenuBase_Factory(__ngFactoryType__) {
      return (ɵCdkMenuBase_BaseFactory || (ɵCdkMenuBase_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuBase)))(
        __ngFactoryType__ || _CdkMenuBase
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var CdkMenuBar = class _CdkMenuBar extends CdkMenuBase {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function CdkMenuBar_Factory(__ngFactoryType__) {
      return (ɵCdkMenuBar_BaseFactory || (ɵCdkMenuBar_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuBar)))(
        __ngFactoryType__ || _CdkMenuBar
      );
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var CdkMenuItemSelectable = class _CdkMenuItemSelectable extends CdkMenuItem {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function CdkMenuItemSelectable_Factory(__ngFactoryType__) {
      return (
        ɵCdkMenuItemSelectable_BaseFactory ||
        (ɵCdkMenuItemSelectable_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuItemSelectable))
      )(__ngFactoryType__ || _CdkMenuItemSelectable);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
...
var CdkMenuItemCheckbox = class _CdkMenuItemCheckbox extends CdkMenuItemSelectable {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function CdkMenuItemCheckbox_Factory(__ngFactoryType__) {
      return (
        ɵCdkMenuItemCheckbox_BaseFactory ||
        (ɵCdkMenuItemCheckbox_BaseFactory = ɵɵgetInheritedFactory(_CdkMenuItemCheckbox))
      )(__ngFactoryType__ || _CdkMenuItemCheckbox);
    };
  })();
  static ɵdir = ɵɵdefineDirective({
